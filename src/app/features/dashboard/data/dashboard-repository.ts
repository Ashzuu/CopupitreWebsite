...
export class DashboardRepository {
  ...
  getAllReinforcementAnnouncements(): Observable<ReinforcementAnnouncement[]> {
    return this.http.get<ReinforcementAnnouncement[]>(this.BASE_API_URL + '/api/reinforcements/all');
  }

  /** Executes the getAllEquipmentRequests action. */
  getAllEquipmentRequests(): Observable<EquipmentRequest[]> {
    return this.http.get<EquipmentRequest[]>(this.BASE_API_URL + '/api/equipments/requests/all');
  }
